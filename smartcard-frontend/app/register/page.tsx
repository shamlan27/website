...
export default function Register() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.confirmPassword) {
      ...
      newShakeFields.push('confirmPassword');
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({ general: 'Network error: ' + (err.message || 'Unable to connect to server') });
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div>
          <div className="text-center">
            ...
            <p className="mt-2 text-sm text-gray-600">
              ...
              <Link href="/login" className="font-medium text-blue-600 hover:text-blue-500 transition-colors duration-200 transform hover:scale-105 inline-block">
                Sign in here
              </Link>
            </p>
          </div>
        ...
        <div className="bg-white py-8 px-6 shadow-xl rounded-lg border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  className={`mt-1 block w-full px-3 py-2 border rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-blue-400 ${
                    errors.firstName
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button
                type="button"
                className="w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-red-50 hover:border-red-300 hover:text-red-600 hover:shadow-md transition-all duration-200 transform hover:scale-105"
              ...
              <button
                type="button"
                className="w-full inline-flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-blue-50 hover:border-blue-300 hover:text-blue-600 hover:shadow-md transition-all duration-200 transform hover:scale-105"
