...
return (
  <div className="min-h-screen font-sans text-black">
      ...
      <header className="relative overflow-hidden hero-gradient py-20">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6">
          <div className="text-center">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight tracking-tight drop-shadow-sm" style={{color: 'var(--foreground)'}}>
              Flash <span className="text-purple-600">Sale</span>
            </h1>
        ...
        <div className="mt-6 bg-gradient-to-r from-pink-300 to-yellow-200 p-6 rounded">
<h3 className="text-xl font-bold">Limited Time Offer</h3>
<p className="mt-2 text-sm">Get extra 10% when you buy 2 or more items — auto applied at checkout.</p>
</div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="text-center mb-10 sm:mb-12 lg:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4" style={{color: 'var(--foreground)'}}>Our <span className="text-purple-600">Sale</span> Products </h2>
                  ...
                  <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-2 sm:gap-0">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <div>
                        ...
                        <div className="text-xs  text-green-600">Up to 40% off</div>
